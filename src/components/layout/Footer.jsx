          ...
          <div>
            ...
            <div className="space-y-3.5">
              {[
                ...
                { icon: Globe, text: "www.tactfreight.com", href: "#" },
            ...
            <div className="flex gap-2 mb-8">
              {socialLinks.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-9 h-9 rounded-xl border border-white/10 bg-white/5 hover:bg-accent hover:border-accent text-white/50 hover:text-white flex items-center justify-center transition-all hover:shadow-lg hover:shadow-accent/25"
                >
                  {s.icon}
                </a>
              ))}
